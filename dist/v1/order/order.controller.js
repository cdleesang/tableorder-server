...
__decorate([
    ...
    __param(1, (0, core_1.TypedQuery)({ type: "assert", assert: (input, errorFactory) => { const decode = input => {
            ...
            const __is = input => {
                return "object" === typeof input && null !== input && ("string" === typeof input.enteredAt && /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])(T|\s)([01][0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9](?:\.[0-9]{1,9})?(Z|[+-]([01][0-9]|2[0-3]):[0-5][0-9])$/i.test(input.enteredAt));
            };
            if (false === __is(input))
                ((input, _path, _exceptionable = true) => {
                    const $guard = core_1.TypedQuery.guard;
                    const $ao0 = (input, _path, _exceptionable = true) => "string" === typeof input.enteredAt && (/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])(T|\s)([01][0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9](?:\.[0-9]{1,9})?(Z|[+-]([01][0-9]|2[0-3]):[0-5][0-9])$/i.test(input.enteredAt) || $guard(_exceptionable, {
...
exports.OrderController = OrderController = __decorate([
    (0, common_1.Controller)({ path: 'order', version: common_1.VERSION_NEUTRAL }),
